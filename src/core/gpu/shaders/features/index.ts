...
import { vegetationInstancingFeature } from './vegetationInstancingFeature';
...
export { vegetationInstancingFeature } from './vegetationInstancingFeature';
...
export const featureRegistry = new Map<string, ShaderFeature>([
  ...
  [vegetationInstancingFeature.id, vegetationInstancingFeature],
]);
